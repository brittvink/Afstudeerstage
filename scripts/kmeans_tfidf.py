...
# Metadata
__program__ = "K-means clustering with TF-IDF"
...
class main():
    def __init__(self):
        ...
        # Set variables.
        self.outdir = os.path.join(str(os.path.dirname(os.path.abspath(__file__))), 'k-meanscluster/td-idf')
    ...
    def start(self):
        """
        Data is vectorized using TfidfVectorizer.
    ...
    def get_top_keywords(self, n_terms, clusters, vectorizer, X):
        ...
        f = open(os.path.join(self.outdir, "top_keywords.txt"), "w")
